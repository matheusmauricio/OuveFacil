...
public class ListarBairro extends AppCompatActivity {
    ...
    public class Task extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            String url = "http://192.168.1.105/OuveFacil/listarBairro.php";
    ...
    public void postHttp(Integer codBai, String nome, final Integer codCid){
        HttpClient httpClient = new DefaultHttpClient();
        HttpPost httpPost = new HttpPost("http://192.168.1.105/OuveFacil/alterarBairro.php");
    ...
    public void postHttpExcluir(Integer codBairro){
        HttpClient httpClient = new DefaultHttpClient();
        HttpPost httpPost = new HttpPost("http://192.168.1.105/OuveFacil/excluirBairro.php");
