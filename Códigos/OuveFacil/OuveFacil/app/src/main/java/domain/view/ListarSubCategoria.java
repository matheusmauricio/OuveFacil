...
public class ListarSubCategoria extends AppCompatActivity {
    ...
    public void postHttp(Integer codSubCategoria, String nome){
        HttpClient httpClient = new DefaultHttpClient();
        HttpPost httpPost = new HttpPost("http://192.168.1.105/OuveFacil/alterarSubCategoria.php");
    ...
    public void postHttpExcluir(Integer codSubCategoria){
        HttpClient httpClient = new DefaultHttpClient();
        HttpPost httpPost = new HttpPost("http://192.168.1.105/OuveFacil/excluirSubCategoria.php");
