    ...
    public void carregarInformacoes(GoogleMap googleMap){
        ...
        try {
            ...
            for (final Denuncia denuncia : param){
                ...
                } else if(Objects.equals(denuncia.getStatus().getNome(), "Concluida")){
                    marker.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
                } else if(Objects.equals(denuncia.getStatus().getNome(), "Concluida por Negacao Popular")){
                    marker.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE));
                } else if(Objects.equals(denuncia.getStatus().getNome(), "Em Analise")){
                    marker.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW));
                } else if(Objects.equals(denuncia.getStatus().getNome(), "Em Fase de Correcao")){
        ...
        protected void onPostExecute(Void v){
            ...
            try {
                ...
                for (int i = 0; i < Jarray.length(); i++) {
                    ...
                    FotoEOuVideo fotoEOuVideo = new FotoEOuVideo();
                    fotoEOuVideo.setUrlFotoVideo(urlFotoVideo);
