...
public class ListarCategoria extends AppCompatActivity {
    ...
    public class Task extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            String url = "http://192.168.1.105/OuveFacil/listarCategoria.php";
    ...
    public class Task2 extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            String url = "http://192.168.1.105/OuveFacil/listarSubCategoria.php";
    ...
    public void postHttp(Integer codCat, String nome, final Integer codSubCat){
        HttpClient httpClient = new DefaultHttpClient();
        HttpPost httpPost = new HttpPost("http://192.168.1.105/OuveFacil/alterarCategoria.php");
    ...
    public void postHttpExcluir(Integer codCategoria){
        HttpClient httpClient = new DefaultHttpClient();
        HttpPost httpPost = new HttpPost("http://192.168.1.105/OuveFacil/excluirCategoria.php");
