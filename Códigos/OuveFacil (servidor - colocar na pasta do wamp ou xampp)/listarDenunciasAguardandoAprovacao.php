<?php
  ...
  denuncia.codStatus, usuario.nome as nomeUsuario, administrador.nome as nomeAdministrador, categoria.nome as
  nomeCategoria, status.nome as nomeStatus, denuncia.midia1, denuncia.midia2, denuncia.midia3, denuncia.midia4,
   denuncia.existe, denuncia.naoExiste
  ...
  AND denuncia.codCategoria = categoria.codCategoria AND denuncia.codStatus = '6' AND denuncia.codStatus = status.codStatus";
