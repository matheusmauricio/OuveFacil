<?php
  ...
  nomeUsuario, administrador.nome as nomeAdministrador, categoria.nome as nomeCategoria,
  ...
  AND denuncia.codAdministrador = administrador.codAdministrador AND
